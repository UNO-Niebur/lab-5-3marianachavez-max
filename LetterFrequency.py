...
def countLetters(message):
    ...
    #(I AM ASSUMING THAT THERE IS NO POSITION, SO I REMOVED THE PORTION THAT WAS ADDED IN THE VIDEO spot = 5, 
    #freq[spot] = freq[spot] + 1, AND REPLACED IT WITH THE CODE ABOVE. OTHERWISE, "F" WAS COUNTED AS A 1 REGARDLESS
    #IF IT WAS IN THE MESSAGE OR NOT.)
